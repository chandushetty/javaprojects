package com.servermain.operation;
import com.server2.*;
...
public class BusinessLevelOperations implements Fileinterface{
	...
	File[] files = new File("C:\\workspace\\Phase1\\src\\assistedpractise").listFiles();
	...
	public void searchFile() {
		...
		try {	
			...
			File directory = new File("C:\\workspace\\Phase1\\src\\assistedpractise");
